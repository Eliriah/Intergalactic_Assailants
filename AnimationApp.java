...
public class AnimationApp{
	...
	public static void main(String[] args){
		...
		Enemy enemy1 = new Enemy(-40,25);
                Enemy enemy2 = new Enemy(-30, 25);
                Enemy enemy3 = new Enemy(-20, 25);
                Enemy enemy4 = new Enemy(-10,25);
                Enemy enemy5 = new Enemy(0, 25);
                enemies.add(enemy1);
                enemies.add(enemy2);
                enemies.add(enemy3);
                enemies.add(enemy4);
		...
		System.out.println("Player Position: "+player1.getX_Coordinate()+", "+player1.getY_Coordinate());
                ...
                for(int i = 0; i<enemies.size(); i++)
                        System.out.println("Enemy " +i +" position : " +enemies.get(i).getX_Coordinate() + ", " + enemies.get(i).getY_Coordinate());
